    ...
    <div className="p-8">
      <div className="mb-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-slate-900">Regular Students</h1>
            <p className="text-slate-600 mt-1">Standard academic program enrollees</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-md overflow-hidden">
        <div className="px-6 py-4 border-b border-slate-200">
          <h2 className="text-xl font-semibold text-slate-900">
            Total Regular Students: {students.length}
          </h2>
        </div>
        ...
        {loading ? (
          ...
          <div className="p-8 text-center text-slate-500">No regular students found</div>
        ) : (
                    ...
                    <td className="px-6 py-4 text-sm text-slate-900">
                      {editingId === student.id ? (
                        <input
                          ...
                          onChange={(e) =>
                            setEditForm({ ...editForm!, strand: e.target.value })
                          }
                          className="border border-slate-300 rounded px-2 py-1 w-full"
                        />
                      ) : (
